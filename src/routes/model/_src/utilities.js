...
//Allows for rollup to switch data root.
const base = dev ? "http://localhost:8080/data/" : "https://nurseproject-dept-healthworkforce.cloudapps.unc.edu/data/";
...
export function makeQueryURL(params, baseURL = base) {
